...
-- 权限表
-- ----------------------------
DROP TABLE IF EXISTS li_permission;
CREATE TABLE li_permission
(
    id          int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- 分组表
-- ----------------------------
DROP TABLE IF EXISTS li_group;
CREATE TABLE li_group
(
    id          int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- 分组-权限表
-- ----------------------------
DROP TABLE IF EXISTS li_group_permission;
CREATE TABLE li_group_permission
(
    id            int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
DROP TABLE IF EXISTS li_user_identity;
CREATE TABLE li_user_identity
(
    id            int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- 用户-分组表
-- ----------------------------
DROP TABLE IF EXISTS li_user_group;
CREATE TABLE li_user_group
(
    id       int(10) unsigned NOT NULL AUTO_INCREMENT,
    user_id  int(10) unsigned NOT NULL COMMENT '用户id',
    group_id int(10) unsigned NOT NULL COMMENT '分组id',
...
INSERT INTO li_user(id, username, nickname)
VALUES (1, 'root', 'root');

INSERT INTO li_user_identity (id, user_id, identity_type, identifier, credential)
VALUES (1, 1, 'USERNAME_PASSWORD', 'root',
        'pbkdf2sha256:64000:18:24:n:yUnDokcNRbwILZllmUOItIyo9MnI00QW:6ZcPf+sfzyoygOU8h/GSoirF');

INSERT INTO li_group(id, name, info, level)
VALUES (1, 'root', '超级用户组', 'root');

INSERT INTO li_group(id, name, info, level)
VALUES (2, 'guest', '游客组', 'guest');

INSERT INTO li_user_group(id, user_id, group_id)
VALUES (1, 1, 1);
